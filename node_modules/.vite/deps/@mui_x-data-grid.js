...
} from "./chunk-KS3Q7WZK.js";
import {
  Box_default
} from "./chunk-W4HYUEOL.js";
import {
  Checkbox_default,
  createSvgIcon
...
import "./chunk-GLC6FJKK.js";
import {
  useTheme
} from "./chunk-QLLWPBAF.js";
import {
  Button_default
} from "./chunk-XOQBEWMB.js";
import "./chunk-X5JW2I66.js";
import {
...
var _excluded8 = ["api", "colDef", "id", "hasFocus", "isEditable", "field", "value", "formattedValue", "row", "rowNode", "cellMode", "tabIndex", "position", "focusElementRef"];
...
function GridFilterInputMultipleValue(props) {
  ...
  return (0, import_jsx_runtime66.jsx)(Autocomplete_default, _extends({
    ...
    value: filterValueState,
    onChange: handleChange,
    renderTags: (value, getTagProps) => value.map((option, index) => (0, import_jsx_runtime66.jsx)(rootProps.slots.baseChip, _extends({
      variant: "outlined",
      size: "small",
      label: option
    }, getTagProps({
...
function GridFilterInputMultipleSingleSelect(props) {
  ...
  return (0, import_jsx_runtime67.jsx)(Autocomplete_default, _extends({
    ...
    onChange: handleChange,
    getOptionLabel,
    renderTags: (value, getTagProps) => value.map((option, index) => (0, import_jsx_runtime67.jsx)(rootProps.slots.baseChip, _extends({
      variant: "outlined",
      size: "small",
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React94.useCallback((event) => {
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const checkIfCanStartEditing = React102.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridColumnGrouping = (apiRef, props) => {
  ...
  const updateColumnGroupingState = React128.useCallback((columnGroupingModel) => {
