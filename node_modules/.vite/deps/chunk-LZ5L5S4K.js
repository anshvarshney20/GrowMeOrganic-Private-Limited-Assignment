...
var SvgIcon = React26.forwardRef(function SvgIcon2(props, ref) {
  ...
  return React26.createElement(Component4, _extends({
    ...
    ref
  }, other), children, titleAccess ? React26.createElement("title", null, titleAccess) : null);
});
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types21.default.oneOf(["action", "disabled", "error", "inherit", "primary", "secondary"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  fontSize: chainPropTypes(import_prop_types21.default.oneOf(["default", "inherit", "large", "medium", "small"]), function(props) {
...
var SvgIcon_default = withStyles_default(styles26, {
  name: "MuiSvgIcon"
})(SvgIcon);
...
function createSvgIcon(path, displayName) {
  ...
  return import_react.default.memo(import_react.default.forwardRef(Component4));
}

// node_modules/@material-ui/core/esm/internal/svg-icons/ArrowDropDown.js
var ArrowDropDown_default = createSvgIcon(React28.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var NativeSelectInput = React29.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return React29.createElement(React29.Fragment, null, React29.createElement("select", _extends({
    className: clsx_m_default(
      classes.root,
      // TODO v5: merge root and select
      classes.select,
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : React29.createElement(IconComponent, {
...
var defaultInput = React30.createElement(Input_default, null);
var NativeSelect = React30.forwardRef(function NativeSelect2(props, ref) {
  ...
  return React30.cloneElement(input, _extends({
...
var _ref = React31.createElement(Input_default, null);
var _ref2 = React31.createElement(FilledInput_default, null);
var Select = React31.forwardRef(function Select2(props, ref) {
  ...
  var InputComponent = input || {
    standard: _ref,
    outlined: React31.createElement(OutlinedInput_default, {
      label,
      labelWidth
    }),
    filled: _ref2
  }[variant];
  return React31.cloneElement(InputComponent, _extends({
...
var TextField = React32.forwardRef(function TextField2(props, ref) {
  ...
  if (variant === "outlined") {
    ...
    if (label) {
      ...
      InputMore.label = React32.createElement(React32.Fragment, null, label, displayRequired && " *");
    }
  }
  if (select) {
  ...
  var InputElement = React32.createElement(InputComponent, _extends({
  ...
  return React32.createElement(FormControl_default, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    color,
    variant
  }, other), label && React32.createElement(InputLabel_default, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? React32.createElement(Select_default, _extends({
    "aria-describedby": helperTextId,
    id,
    labelId: inputLabelId,
    value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React32.createElement(FormHelperText_default, _extends({
    id: helperTextId
...
//# sourceMappingURL=chunk-LZ5L5S4K.js.map
